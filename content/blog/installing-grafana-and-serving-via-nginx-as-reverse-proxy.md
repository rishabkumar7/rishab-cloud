...
date: "2021-10-15T13:46:35.061Z"
description: "Hey Friends 👋\nHope everyone is doing great. It's been a few month since I last published an article. I was busy with getting more YouTube videos out. And did I mention I was on the Microsoft Reactor Session with Gwyneth Pena on Deploy a Containerize..."
slug: "installing-grafana-and-serving-via-nginx-as-reverse-proxy"
url: "/blog/installing-grafana-and-serving-via-nginx-as-reverse-proxy/"
draft: false
tags:
  - "monitoring"
  - "nginx"
  ...
  - "dailydev"
cover:
  image: "/images/blog/installing-grafana-and-serving-via-nginx-as-reverse-proxy/cVo6zmlhb-ed78ee2594.png"
  alt: "Installing Grafana and serving via Nginx as reverse proxy"
hashnode:
  id: "6169863b53401f641ba1835b"
...
![image.png](/images/blog/installing-grafana-and-serving-via-nginx-as-reverse-proxy/vqtXrsnHH-81cff15d15.png)
...
![giphy.gif](/images/blog/installing-grafana-and-serving-via-nginx-as-reverse-proxy/N5DSDoP0d-9632af2314.gif)
